...
namespace Advent_2022.Solutions
{
	public static class Day4
	{
		...
		{
			List<int> rangeA = Enumerable.Range((int) boundsA.X, (int) (boundsA.Y - boundsA.X) + 1).ToList();
			List<int> rangeB = Enumerable.Range((int) boundsB.X, (int) (boundsB.Y - boundsB.X) + 1).ToList();
